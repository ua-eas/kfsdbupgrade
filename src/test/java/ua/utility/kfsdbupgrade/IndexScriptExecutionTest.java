...
public class IndexScriptExecutionTest extends AppTestBase {
    private static final String SQL_INDEX_TEST_FILE = "uaf-2483.sql";
    ...
    private void deleteBiMaterializedViews(App app) {
        Connection conn = null;
        Statement stmt = null;
        try {
            conn = app.getUpgradeConnection();
            ...
            throw new RuntimeException("Could not delete views: " + e.getMessage());
        } finally {
            app.closeDbObjects(conn, stmt, null);
        }
    }

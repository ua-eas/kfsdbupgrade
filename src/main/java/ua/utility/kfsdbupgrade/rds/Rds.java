...
public final class Rds {
  ...
  public static String checkedName(String name) {
    ...
    checkArgument(name.length() < 63, "[%s] %s characters is too long, max is 63", name, name.length() + 1);
  ...
  public static String checkedSid(String sid) {
    ...
    checkArgument(sid.length() < 8, "[%s] %s characters is too long, max is 8", sid, sid.length() + 1);
